  <footer>
      <div class="container-fluid fluidgap">
          <div class="row">
              <img src="assets/img/logoblack.png" class="logo" alt="">
          </div>
          <div class="row pt-5">
              <div class="col">
                  <div class="">
                      <h5>Features</h5>
                      <p>Find the right home builder</p>
                      <p>Find the right floor plan</p>
                      <p>Milestones</p>
                      <p>Build cost tracker</p>
                      <p>Selections / inspiration feed</p>
                      <p>Construction progress feed</p>
                      <p>Floor plan &amp; elevation feed</p>
                  </div>
              </div>
              <div class="col">
                  <div class="">
